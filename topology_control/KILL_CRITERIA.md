...
> **Что изменено в этом файле 2026-08-30:** ни одна планка, формула или порог.
> Добавлены три блока «ИСХОД» с фактическими результатами и датами.
> Интерпретационное решение (засчитать переформулированную D1) — в `AMENDMENTS.md` A-004.
...
| **H1** МтДНК redox | `Independent: не зависит от T2/D1` | ✅ **единственное живое направление** |
