  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (active.length > 0) {
        ...
        const leftR = nearby.find(
          (s) => s.orientation === "R" && s.position <= c.leftLeg,
        );
        const rightF = nearby.find(
          (s) => s.orientation === "F" && s.position >= c.rightLeg,
        );
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            style={{
              fontSize: "18px",
              fontWeight: "bold",
              color: debugInfo.activeCohesin > 0 ? "#0f0" : "#f00",
            }}
          >
        ...
        >
          ...
          >
            ...
            <div
              style={{ fontSize: "18px", fontWeight: "bold", color: "#ff0" }}
            >
          ...
          debugInfo.convergentPairs.map(([f, r], i) => (
            ...
            >
              ...
              <span style={{ color: "#0f0" }}>
                F@{f.position.toLocaleString()} → R@
                {r.position.toLocaleString()}
              </span>
      ...
      {debugInfo.lastCheck && (
        <div style={{ borderTop: "1px solid #333", paddingTop: "10px" }}>
          ...
          >
            <div>
              Cohesin: {debugInfo.lastCheck.cohesinLeft.toLocaleString()} -{" "}
              {debugInfo.lastCheck.cohesinRight.toLocaleString()}
            </div>
            ...
            {debugInfo.lastCheck.nearbyCTCF.map((ctcf, i) => (
              ...
              >
                {ctcf.orientation}@{ctcf.position.toLocaleString()} (
                {(ctcf.distance / 1000).toFixed(1)}kb)
              </div>
            ))}
          </div>
          ...
          >
            <div
              style={{
                color: debugInfo.lastCheck.isConvergent ? "#0f0" : "#f00",
                fontWeight: "bold",
              }}
            >
              {debugInfo.lastCheck.isConvergent
                ? "✅ CONVERGENT"
                : "❌ NOT CONVERGENT"}
            </div>
