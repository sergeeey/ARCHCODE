    ...
    >
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <section className="text-center max-w-2xl mb-16">
          ...
          <p className="text-lg mb-8" style={{ color: "var(--text-muted)" }}>
            Chromatin loop extrusion with CTCF boundaries. Publication-ready;
            validation target: experimental Hi-C (Rao et al.).
          </p>
          <Link to="/simulator">
        ...
        <section className="w-full max-w-3xl grid md:grid-cols-2 gap-6 mb-16">
          ...
          >
            ...
            <p style={{ color: "var(--text-muted)" }}>
              Cohesin motors extrude DNA until blocked by convergent CTCF.
      ...
      >
        <div className="max-w-5xl mx-auto flex flex-wrap items-center justify-center gap-6 text-sm font-mono">
          <a
            href="https://github.com/sergeeey/ARCHCODE"
            target="_blank"
