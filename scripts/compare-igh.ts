...
function main() {
    const beta0Path = path.join(__dirname, '..', 'results', 'ensemble_igh_beta0.json');
    const beta5Path = path.join(__dirname, '..', 'results', 'ensemble_igh_beta5.json');
    ...
    console.log('='.repeat(70));
    console.log('');
    console.log(`Locus: ${beta5.locus.name} (${beta5.locus.chrom}:${beta5.locus.start.toLocaleString()}-${beta5.locus.end.toLocaleString()})`);
    ...
    console.log(`| Max diff location (i,j)  | (${diff.maxI}, ${diff.maxJ})`.padEnd(42) + '|');
    console.log('');
    ...
    console.log(`Max diff genomic region: ${maxDiffPosStart.toLocaleString()}-${maxDiffPosEnd.toLocaleString()}`);
    console.log('');
    ...
    if (hasSignificantDiff) {
        console.log('✓ PASS: FountainLoader shows significant spatial signal effect on IGH locus');
    ...
    const outPath = path.join(__dirname, '..', 'results', 'diff_igh_beta5_vs_beta0.json');
