...
async function runSimulation() {
    ...
    console.log(`📊 Expected matrix: ${LOCUS.length / LOCUS.resolution}x${LOCUS.length / LOCUS.resolution}\n`);
    ...
    const matrixPath = path.join(outputDir, 'archcode_hbb_simulation_matrix.json');
    ...
    const numpyPath = path.join(outputDir, 'archcode_hbb_simulation_matrix_flat.json');
