...
**П1 ЧАСТИЧНО.** Числитель собран из опубликованных компонентов: Pol II 2–4 тыс.п.н./мин,
сплайсинг 7–14 мин, экспорт 5–40 мин, цитозольная трансляция ~6 аа/с, итого **30–60 мин
и более**. Знаменатель — **скорость элонгации миторибосомы — в литературе НЕ ИЗМЕРЕНА**
(признанный пробел, стандартизированных значений в аа/с нет). τ_real остаётся [UNKNOWN],
но блокировка теперь адресная: нужна ОДНА величина.

**τ_ratio = 100 из старого критерия не подкреплено ничем.** Покомпонентно (у митохондрий
структурно нет сплайсинга и экспорта) выходит порядка **10** — [INFERRED], LOW. И это
не важно: нулевая модель насыщается при τ_ratio ≈ 8, выбор между 10 и 100 на исход не
влияет, что делает старый критерий ещё менее информативным.
